...
export const approvalsList = data => createAPI(`/api/audit/audit/procinstance/queryPage?page=${data.page}&limit=${data.limit}`, 'post', data)
export const approvalsDetail = data => createAPI(`/api/audit/audit/procinstance/info/${data.id}`, 'get', null)
