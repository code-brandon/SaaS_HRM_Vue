  ...
  <div class="add-form">
    <el-dialog title="编辑员工" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="formBase" label-position="left" label-width="120px" style="margin-left:120px; width:500px;">
        <el-form-item label="姓名："><el-input v-model="formBase.username" placeholder="1-30个字符"></el-input></el-form-item>
        <el-form-item label="手机："><el-input v-model="formBase.mobile" placeholder="请输入手机号" class="inputW"></el-input></el-form-item>
        ...
        <el-form-item label="聘用形式：">
          <el-select class="filter-item" v-model="formBase.formOfEmployment">
            <el-option v-for="item in employeesData" :key="item.id" :label="item.value" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="工号："><el-input type="number" v-model="formBase.workNumber" placeholder="1-20个字符"></el-input></el-form-item>
        ...
        <el-form-item label="转正时间：">
          <el-date-picker v-model="formBase.correctionTime" type="date" value-format="yyyy-MM-dd" placeholder="选择日期"></el-date-picker>
        </el-form-item>
      </el-form>
